...
@TinyFW.test_method(app=BL602App.BL602App, dut=BL602DUT.BL602TyMbDUT, test_suite_name='sdk_app_uart_ctl_tc')
def sdk_app_uart_ctl_tc(env, extra_data):
    # first, flash dut
    # then, test
    ...
    try:
        ...
        print('ENV_TEST_FAILURE: BL602 uart ctl test failed')
        raise
