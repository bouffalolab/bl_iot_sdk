...
E21_CPU_LDFLAGS := -march=rv32imafcpzpsfoperand_xtheade -mabi=ilp32f -mtune=e907
else
ifeq ("$(CPU_ID)", "D0")
E21_CPU_LDFLAGS := -march=rv64imafdcv0p7_zfh_xtheadc -mabi=lp64d -mtune=c906
endif
endif
...
ifeq ("$(CPU_ID)" ,$(filter "$(CPU_ID)", "M1" "M0"))
E21_CPU_CFLAGS := -march=rv32imafcpzpsfoperand_xtheade -mabi=ilp32f -mtune=e907 -mcmodel=medany
else
ifeq ("$(CPU_ID)", "D0")
E21_CPU_CFLAGS := -march=rv64imafdcv0p7_zfh_xtheadc -mabi=lp64d -mtune=c906 -mcmodel=medany
endif
endif
