...
enum insn_code {
  ...
  CODE_FOR_riscv_csr_read = 272,
  CODE_FOR_riscv_csr_read_set_bits = 273,
  CODE_FOR_riscv_csr_read_clear_bits = 274,
  CODE_FOR_riscv_csr_read_write = 275,
  CODE_FOR_riscv_csr_write = 276,
  CODE_FOR_riscv_mret = 277,
  CODE_FOR_riscv_sret = 278,
  CODE_FOR_riscv_uret = 279,
  CODE_FOR_stack_tiesi = 280,
  CODE_FOR_stack_tiedi = 281,
  ...
  CODE_FOR_mulditi3 = 337,
  CODE_FOR_umulditi3 = 338,
  CODE_FOR_usmulditi3 = 339,
  CODE_FOR_mulsidi3 = 340,
  CODE_FOR_umulsidi3 = 341,
  CODE_FOR_usmulsidi3 = 342,
  CODE_FOR_movdi = 343,
  CODE_FOR_movsi = 344,
  CODE_FOR_movhi = 345,
  CODE_FOR_movqi = 346,
  CODE_FOR_movsf = 347,
  CODE_FOR_movdf = 348,
  CODE_FOR_movmemsi = 349,
  CODE_FOR_clear_cache = 350,
  CODE_FOR_movsicc = 351,
  CODE_FOR_movdicc = 352,
  CODE_FOR_condjump = 353,
  CODE_FOR_cbranchqi4 = 354,
  CODE_FOR_cbranchsi4 = 355,
  CODE_FOR_cbranchdi4 = 356,
  CODE_FOR_cbranchsf4 = 357,
  CODE_FOR_cbranchdf4 = 358,
  CODE_FOR_cstoresi4 = 359,
  CODE_FOR_cstoredi4 = 360,
  CODE_FOR_cstoresf4 = 361,
  CODE_FOR_cstoredf4 = 362,
  CODE_FOR_flt_quietsfsi4 = 363,
  CODE_FOR_fle_quietsfsi4 = 364,
  CODE_FOR_flt_quietsfdi4 = 365,
  CODE_FOR_fle_quietsfdi4 = 366,
  CODE_FOR_flt_quietdfsi4 = 367,
  CODE_FOR_fle_quietdfsi4 = 368,
  CODE_FOR_flt_quietdfdi4 = 369,
  CODE_FOR_fle_quietdfdi4 = 370,
  CODE_FOR_indirect_jump = 371,
  CODE_FOR_tablejump = 372,
  CODE_FOR_prologue = 373,
  CODE_FOR_epilogue = 374,
  CODE_FOR_sibcall_epilogue = 375,
  CODE_FOR_return = 376,
  CODE_FOR_eh_return = 377,
  CODE_FOR_sibcall = 378,
  CODE_FOR_sibcall_value = 379,
  CODE_FOR_call = 380,
  CODE_FOR_call_value = 381,
  CODE_FOR_untyped_call = 382,
  CODE_FOR_restore_stack_nonlocal = 383,
  CODE_FOR_mem_thread_fence = 384,
  CODE_FOR_atomic_compare_and_swapsi = 385,
  CODE_FOR_atomic_compare_and_swapdi = 386,
  CODE_FOR_atomic_test_and_set = 387
};

const unsigned int NUM_INSN_CODES = 388;
