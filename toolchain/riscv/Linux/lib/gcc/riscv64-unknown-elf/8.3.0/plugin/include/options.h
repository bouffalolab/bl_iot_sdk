...
enum opt_code
{
  ...
  OPT_mabi_ = 1190,                          /* -mabi= */
  OPT_malign_data_ = 1191,                   /* -malign-data= */
  OPT_march_ = 1192,                         /* -march= */
  ...
  OPT_mplt = 1198,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1199,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1200,                         /* -mrelax */
  OPT_mriscv_attribute = 1201,               /* -mriscv-attribute */
  OPT_msave_restore = 1202,                  /* -msave-restore */
  OPT_msmall_data_limit_ = 1203,             /* -msmall-data-limit= */
  OPT_mstrict_align = 1204,                  /* -mstrict-align */
  OPT_mtune_ = 1205,                         /* -mtune= */
  OPT_n = 1206,                              /* -n */
  OPT_no_canonical_prefixes = 1207,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1208,              /* -no-integrated-cpp */
  OPT_no_pie = 1209,                         /* -no-pie */
  ...
  OPT_static_pie = 1256,                     /* -static-pie */
  ...
  OPT_std_c__2a = 1264,                      /* -std=c++2a */
  OPT_std_c__98 = 1265,                      /* -std=c++98 */
  OPT_std_c11 = 1266,                        /* -std=c11 */
  OPT_std_c17 = 1267,                        /* -std=c17 */
  /* OPT_std_c18 = 1268, */                  /* -std=c18 */
  ...
  OPT_std_gnu__2a = 1287,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1288,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1289,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1290,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1291, */                /* -std=gnu18 */
  ...
  /* OPT_std_iso9899_2017 = 1302, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1303, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1304,                     /* -std=legacy */
  OPT_symbolic = 1305,                       /* -symbolic */
  OPT_t = 1306,                              /* -t */
  OPT_time = 1307,                           /* -time */
  OPT_time_ = 1308,                          /* -time= */
  OPT_traditional = 1309,                    /* -traditional */
  OPT_traditional_cpp = 1310,                /* -traditional-cpp */
  OPT_trigraphs = 1311,                      /* -trigraphs */
  OPT_u = 1312,                              /* -u */
  OPT_undef = 1313,                          /* -undef */
  OPT_v = 1314,                              /* -v */
  OPT_version = 1315,                        /* -version */
  OPT_w = 1316,                              /* -w */
  OPT_wrapper = 1317,                        /* -wrapper */
  OPT_x = 1318,                              /* -x */
  OPT_z = 1319,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
