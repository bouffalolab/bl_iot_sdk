...
enum opt_code
{
  ...
  OPT_mdiv = 1610,                           /* -mdiv */
  OPT_mdup_loop_header = 1611,               /* -mdup-loop-header */
  OPT_mexpand_split_imm = 1612,              /* -mexpand-split-imm */
  OPT_mexplicit_relocs = 1613,               /* -mexplicit-relocs */
  OPT_mext = 1614,                           /* -mext */
  OPT_mfclass = 1615,                        /* -mfclass */
  OPT_mfdiv = 1616,                          /* -mfdiv */
  OPT_mfldr = 1617,                          /* -mfldr */
  OPT_mfmvhw32 = 1618,                       /* -mfmvhw32 */
  OPT_mfp16 = 1619,                          /* -mfp16 */
  OPT_minvariant_as_constant = 1620,         /* -minvariant-as-constant */
  OPT_mipa_unhot_inline = 1621,              /* -mipa-unhot-inline */
  OPT_mipush = 1622,                         /* -mipush */
  OPT_miv_adjust_addr_cost = 1623,           /* -miv-adjust-addr-cost */
  OPT_mldd = 1624,                           /* -mldd */
  OPT_mldi = 1625,                           /* -mldi */
  OPT_mldr = 1626,                           /* -mldr */
  OPT_mmula = 1627,                          /* -mmula */
  OPT_mplt = 1628,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1629,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1630,                         /* -mrelax */
  OPT_mrev = 1631,                           /* -mrev */
  OPT_mrevw = 1632,                          /* -mrevw */
  OPT_mriscv_attribute = 1633,               /* -mriscv-attribute */
  OPT_msave_restore = 1634,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1635,               /* -mshorten-memrefs */
  OPT_msignedness_cmpiv = 1636,              /* -msignedness-cmpiv */
  OPT_msmall_data_limit_ = 1637,             /* -msmall-data-limit= */
  OPT_msrri = 1638,                          /* -msrri */
  OPT_msrriw = 1639,                         /* -msrriw */
  OPT_mstrict_align = 1640,                  /* -mstrict-align */
  OPT_mthread_jumps1 = 1641,                 /* -mthread-jumps1 */
  OPT_mtune_ = 1642,                         /* -mtune= */
  OPT_mvlen_ = 1643,                         /* -mvlen= */
  OPT_mxor_combine = 1644,                   /* -mxor-combine */
  OPT_n = 1645,                              /* -n */
  OPT_name_sort = 1646,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1647,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1648,              /* -no-integrated-cpp */
  OPT_no_pie = 1649,                         /* -no-pie */
  OPT_nocpp = 1650,                          /* -nocpp */
  OPT_nodefaultlibs = 1651,                  /* -nodefaultlibs */
  OPT_nolibc = 1652,                         /* -nolibc */
  OPT_nophoboslib = 1653,                    /* -nophoboslib */
  OPT_nostartfiles = 1654,                   /* -nostartfiles */
  OPT_nostdinc = 1655,                       /* -nostdinc */
  OPT_nostdinc__ = 1656,                     /* -nostdinc++ */
  OPT_nostdlib = 1657,                       /* -nostdlib */
  OPT_o = 1658,                              /* -o */
  OPT_objects = 1659,                        /* -objects */
  OPT_p = 1660,                              /* -p */
  OPT_pass_exit_codes = 1661,                /* -pass-exit-codes */
  /* OPT_pedantic = 1662, */                 /* -pedantic */
  OPT_pedantic_errors = 1663,                /* -pedantic-errors */
  OPT_pg = 1664,                             /* -pg */
  OPT_pie = 1665,                            /* -pie */
  OPT_pipe = 1666,                           /* -pipe */
  OPT_print_file_name_ = 1667,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1668,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1669,          /* -print-multi-directory */
  OPT_print_multi_lib = 1670,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1671,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1672,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1673,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1674,               /* -print-prog-name= */
  OPT_print_search_dirs = 1675,              /* -print-search-dirs */
  OPT_print_sysroot = 1676,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1677,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1678,                    /* -print-value */
  OPT_quiet = 1679,                          /* -quiet */
  OPT_r = 1680,                              /* -r */
  OPT_remap = 1681,                          /* -remap */
  OPT_reverse_sort = 1682,                   /* -reverse-sort */
  OPT_s = 1683,                              /* -s */
  OPT_save_temps = 1684,                     /* -save-temps */
  OPT_save_temps_ = 1685,                    /* -save-temps= */
  OPT_shared = 1686,                         /* -shared */
  OPT_shared_libgcc = 1687,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1688,               /* -shared-libphobos */
  OPT_size_sort = 1689,                      /* -size-sort */
  /* OPT_specs = 1690, */                    /* -specs */
  OPT_specs_ = 1691,                         /* -specs= */
  OPT_static = 1692,                         /* -static */
  OPT_static_libasan = 1693,                 /* -static-libasan */
  OPT_static_libgcc = 1694,                  /* -static-libgcc */
  OPT_static_libgfortran = 1695,             /* -static-libgfortran */
  OPT_static_libgo = 1696,                   /* -static-libgo */
  OPT_static_liblsan = 1697,                 /* -static-liblsan */
  OPT_static_libmpx = 1698,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1699,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1700,               /* -static-libphobos */
  OPT_static_libstdc__ = 1701,               /* -static-libstdc++ */
  OPT_static_libtsan = 1702,                 /* -static-libtsan */
  OPT_static_libubsan = 1703,                /* -static-libubsan */
  OPT_static_pie = 1704,                     /* -static-pie */
  /* OPT_std_c__03 = 1705, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1706, */                /* -std=c++0x */
  OPT_std_c__11 = 1707,                      /* -std=c++11 */
  OPT_std_c__14 = 1708,                      /* -std=c++14 */
  OPT_std_c__17 = 1709,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1710, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1711, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1712, */                /* -std=c++20 */
  OPT_std_c__2a = 1713,                      /* -std=c++2a */
  OPT_std_c__98 = 1714,                      /* -std=c++98 */
  OPT_std_c11 = 1715,                        /* -std=c11 */
  OPT_std_c17 = 1716,                        /* -std=c17 */
  /* OPT_std_c18 = 1717, */                  /* -std=c18 */
  /* OPT_std_c1x = 1718, */                  /* -std=c1x */
  OPT_std_c2x = 1719,                        /* -std=c2x */
  /* OPT_std_c89 = 1720, */                  /* -std=c89 */
  OPT_std_c90 = 1721,                        /* -std=c90 */
  OPT_std_c99 = 1722,                        /* -std=c99 */
  /* OPT_std_c9x = 1723, */                  /* -std=c9x */
  OPT_std_f2003 = 1724,                      /* -std=f2003 */
  OPT_std_f2008 = 1725,                      /* -std=f2008 */
  OPT_std_f2008ts = 1726,                    /* -std=f2008ts */
  OPT_std_f2018 = 1727,                      /* -std=f2018 */
  OPT_std_f95 = 1728,                        /* -std=f95 */
  OPT_std_gnu = 1729,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1730, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1731, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1732,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1733,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1734,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1735, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1736, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1737, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1738,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1739,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1740,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1741,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1742, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1743, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1744,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1745, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1746,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1747,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1748, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1749, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1750,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1751, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1752, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1753, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1754, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1755, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1756,                     /* -std=legacy */
  OPT_symbol_ = 1757,                        /* -symbol= */
  OPT_symbolic = 1758,                       /* -symbolic */
  OPT_t = 1759,                              /* -t */
  OPT_time = 1760,                           /* -time */
  OPT_time_ = 1761,                          /* -time= */
  OPT_traditional = 1762,                    /* -traditional */
  OPT_traditional_cpp = 1763,                /* -traditional-cpp */
  OPT_tree_stats = 1764,                     /* -tree-stats */
  OPT_trigraphs = 1765,                      /* -trigraphs */
  OPT_type_stats = 1766,                     /* -type-stats */
  OPT_u = 1767,                              /* -u */
  OPT_undef = 1768,                          /* -undef */
  OPT_v = 1769,                              /* -v */
  OPT_version = 1770,                        /* -version */
  OPT_w = 1771,                              /* -w */
  OPT_wrapper = 1772,                        /* -wrapper */
  OPT_x = 1773,                              /* -x */
  OPT_z = 1774,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
