...
static const uint8_t gc0308_reglist[][2] =
{
        {0xfe , 0x80},
...
#if 0   // default max dgain
        {0xee , 0xa0},
        {0xef , 0x40},
#else   // increased max dgain
        {0xee , 0xf0},
        {0xef , 0x60},
#endif
        {0x80 , 0x03},
...
int gc0308_probe(void)
{
    uint8_t id = 0;
    SCCB_Read(GC0308_ADDR, 0x00, &id);
...
int gc0308_reset(smart_sensor_t *sensor)
{
    int i;
    for (i = 0; i < sizeof(gc0308_reglist)/sizeof(gc0308_reglist[0]); i++){
       SCCB_Write(GC0308_ADDR, gc0308_reglist[i][0], gc0308_reglist[i][1]);
    }
...
#if 0
const rt_camera_desc __rt_camera_gc0308_desc __attribute__((section(".camera_desc"))) =
{
    "__rti_name_gc0308",
    GC0308_ADDR,
    .frm_vld_high = 1,
...
#else
const BL_SENSOR_DESC_T sensor_desc_gc0308 ATTR_SENSOR_DEVICE_TABLE =
{
	"GC0308",
	GC0308_ADDR,
	gc0308_probe,
