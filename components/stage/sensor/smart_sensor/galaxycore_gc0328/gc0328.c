...
static const uint8_t gc0328_reglist[][2] =
{
    {0xfe, 0x80},
    {0xfe, 0x80},
    {0xfc, 0x16},
...
int gc0328_probe(void)
{
    uint8_t id = 0;
    SCCB_Read(GC0328_ADDR, SENSOR_ID_REG, &id);
...
int gc0328_reset(smart_sensor_t *sensor)
{
    int i;
    for (i = 0; i < sizeof(gc0328_reglist)/sizeof(gc0328_reglist[0]); i++){
       SCCB_Write(GC0328_ADDR, gc0328_reglist[i][0], gc0328_reglist[i][1]);
    }

    return 0;
}

const BL_SENSOR_DESC_T sensor_desc_gc0328 ATTR_SENSOR_DEVICE_TABLE =
{
	"GC0328",
	GC0328_ADDR,
	gc0328_probe,
