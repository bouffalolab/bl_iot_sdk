...
typedef size_t (* zfill_data)(void *zf, uint8_t *buf, size_t size, uint32_t tx_pos);
...
#define ZDEBUG 0
/* sz.c */
extern void zs_start(zfile_t *zf);
/* rz.c */
extern void zr_start(zfile_t *zf);
...
int zdevice_init(void);
void zdevice_uninit(void);
