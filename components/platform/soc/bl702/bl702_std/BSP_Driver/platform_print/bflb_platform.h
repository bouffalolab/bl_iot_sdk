...
#define BL_CASE_FAIL            {MSG(__FILE__);MSG("Case Fail");while(1){BL702_Delay_US(10);}}
#define BL_CASE_SUCCESS         {MSG(__FILE__);MSG("Case Success");while(1){BL702_Delay_US(10);}}
