 ...
 *
 *******************************************************************************/
void ATTR_TCM_SECTION BL702_Delay_US_Divu(uint32_t cnt)
{
 ...
 *
 *******************************************************************************/
void ATTR_TCM_SECTION BL702_Delay_MS_Divu(uint32_t cnt)
{
    uint32_t i = 0;
    uint32_t count = 0;
    ...
    if(cnt>=1024){
        ...
        for(i=0;i<(cnt/1024);i++){
            BL702_Delay_US_Divu(1024*1000);
        }
    }
    count = cnt&0x3FF;
    if(count){
        /* delay (1-1023)ms */
        BL702_Delay_US_Divu(count*1000);
    }
}
