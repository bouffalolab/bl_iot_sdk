...
#ifndef BFLB_USE_ROM_DRIVER
__WEAK
void* ATTR_TCM_SECTION BL702_MemCpy(void *dst, const void *src, uint32_t n)
{
    const uint8_t *p = src;
    uint8_t *q = dst;
...
#ifndef BFLB_USE_ROM_DRIVER
__WEAK
uint32_t* ATTR_TCM_SECTION BL702_MemCpy4(uint32_t *dst, const uint32_t *src, uint32_t n)
{
...
#ifndef BFLB_USE_ROM_DRIVER
__WEAK
void* ATTR_TCM_SECTION BL702_MemCpy_Fast(void *pdst, const void *psrc, uint32_t n)
{
    ...
    if(((uint32_t)dst&0x3)==0&&((uint32_t)src&0x3)==0){
        BL702_MemCpy4((uint32_t *)dst,(const uint32_t *)src,n>>2);
        left=n%4;
        done=n-left;
        while(i<left){
...
{
    return BL702_MemCpy_Fast(pdst,psrc,n);
}
#endif
/****************************************************************************//**
 * @brief  char memset
...
#ifndef BFLB_USE_ROM_DRIVER
__WEAK
void* ATTR_TCM_SECTION BL702_MemSet(void *s, uint8_t c, uint32_t n)
{
    uint8_t *p = (uint8_t*) s;
...
#ifndef BFLB_USE_ROM_DRIVER
__WEAK
uint32_t* ATTR_TCM_SECTION BL702_MemSet4(uint32_t *dst, const uint32_t val, uint32_t n)
{
    uint32_t *q = dst;
...
#ifndef BFLB_USE_ROM_DRIVER
__WEAK
int ATTR_TCM_SECTION BL702_MemCmp(const void *s1, const void *s2, uint32_t n)
{
