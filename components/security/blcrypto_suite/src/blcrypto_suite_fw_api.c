...
{
    return blcrypto_suite_mpi_add_mpi((blcrypto_suite_mpi *) c, (const blcrypto_suite_mpi *) a, (const blcrypto_suite_mpi *) b) ?
           -1 : 0;
}
                          ...
                          struct crypto_bignum *c)
{
    return blcrypto_suite_mpi_inv_mod((blcrypto_suite_mpi *) c, (const blcrypto_suite_mpi *) a,
                               (const blcrypto_suite_mpi *) b) ? -1 : 0;
}
...
int crypto_bignum_sub(const struct crypto_bignum *a,
                      ...
                      struct crypto_bignum *c)
{
    return blcrypto_suite_mpi_sub_mpi((blcrypto_suite_mpi *) c, (const blcrypto_suite_mpi *) a, (const blcrypto_suite_mpi *) b) ?
           -1 : 0;
}
...
int crypto_bignum_div(const struct crypto_bignum *a,
                      ...
                      struct crypto_bignum *c)
{
    return blcrypto_suite_mpi_div_mpi((blcrypto_suite_mpi *) c, NULL, (const blcrypto_suite_mpi *) a, (const blcrypto_suite_mpi *) b) ?
           -1 : 0;
}
