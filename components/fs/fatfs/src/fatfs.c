...
#if FF_DEV_REGISTER_USE_WIFIRAM
#define ATTR_WIFI_RAM  __attribute__ ((aligned(8))) __attribute__  ((section(".wifi_ram")))
static char g_fatfs_buf[sizeof(FATFS)] ATTR_WIFI_RAM;
#endif
